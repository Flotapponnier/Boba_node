  ...
  return (
    <div className="config-section">
      <SectionHeader
        ...
        tooltip="Production-grade monitoring for BSC node with Geth Exporter sidecar, Prometheus ServiceMonitor, and Grafana dashboards. Includes 15+ alerts for critical issues (node down, sync stalled), warnings (low peers, disk space), and performance metrics. Essential for production operations."
      />
            ...
            <div className="form-grid three-columns">
              <div className="form-group">
                <label>
                  ...
                  <HelpTooltip content="Docker image for the Geth Exporter. Default: etclabscore/gethexporter (official community image, compatible with BSC)." />
                </label>
                <input
                  type="text"
          ...
          <div className="form-group">
            <label className="checkbox-label">
              ...
              <span>
                ...
                <HelpTooltip content="Deploys production-ready BSC alerts with Slack notifications: CRITICAL (NodeDown, NotSyncing, DiskSpaceCritical), WARNING (DiskSpaceWarning, HighMemoryUsage, TxPoolOverload), PERFORMANCE (HighCPUUsage, HighIOWait, PredictDiskFull). Configure individual alerts and thresholds below." />
              </span>
            </label>
          </div>
                ...
                <div className="form-group" style={{ paddingLeft: '15px', borderLeft: '3px solid #ef4444' }}>
                  <label className="checkbox-label">
                    ...
                    <span>Disk Space Critical - Very low disk space remaining
                      <HelpTooltip content="Critical alert when available disk space falls below threshold (default 10%). Requires immediate action - expand storage or prune data. BSC nodes can fill disks quickly during sync." />
                    </span>
                  </label>
                ...
                <div className="form-group" style={{ paddingLeft: '15px', borderLeft: '3px solid #3b82f6' }}>
                  <label className="checkbox-label">
                    ...
                    <span>High IO Wait - System I/O constrained
                      <HelpTooltip content="Performance alert when I/O wait time exceeds threshold (default 20%). Indicates disk performance bottleneck. Check disk IOPS and throughput. BSC nodes require minimum 3000 IOPS, optimal 8000+ IOPS. Consider upgrading to faster NVMe SSD." />
                    </span>
                  </label>
